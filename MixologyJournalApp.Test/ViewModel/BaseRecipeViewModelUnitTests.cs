...
namespace MixologyJournalApp.Test.ViewModel
{
    ...
    public class BaseRecipeViewModelUnitTests : BaseViewModelUnitTests
    {
        ...
        public void DefaultConstructorTest()
        {
            ...
            Assert.AreEqual(null, viewModel.FavoriteRecipe);
        ...
        public void BasicConstructorTest()
        {
            ...
            Assert.IsNotNull(viewModel.FavoriteRecipe);
        ...
        public void SaveTest()
        {
            ...
            viewModel.Instructions = newInstructions;
            viewModel.FavoriteRecipe = null;
            viewModel.AddModifiedRecipe(viewModel.Clone());
            viewModel.AddIngredient(new IngredientViewModel(app));
        ...
        public void FavoritePropertyChangedTest()
        {
            ...
            viewModel.FavoriteRecipe = modified;
            Assert.IsTrue(eventHappened);
        }
    }
}
