...
namespace MixologyJournalApp.Test.ViewModel
{
    ...
    public class EditIngredientViewModelUnitTests : BaseViewModelUnitTests
    {
        ...
        public void DefaultConstructorTest()
        {
            ...
            Assert.AreEqual(new EditAmountViewModel(new Amount(0.0, AmountUnit.Ounce), app), vm.Amount);
        ...
        public void NormalConstructorTest()
        {
            ...
            Assert.AreEqual(new EditAmountViewModel(amt, app), vm.Amount);
        ...
        public void CloneTest()
        {
            ...
            Assert.AreEqual(new EditAmountViewModel(amt, app), clone.Amount);
